window.orderApp = {
    ...
    _initGrid: function () {
        ...
        render: function(data, type, row) {
            // The button now calls the API endpoint and opens it in a new browser tab
            return `<a href="/api/sales/orders/${row.id}/pdf" target="_blank" class="btn btn-sm btn-outline-danger shadow-sm" title="Export PDF Quote">
